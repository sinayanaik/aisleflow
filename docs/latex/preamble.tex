% Preamble for toll.tex. LuaLaTeX only.
...
\hypersetup{
  pdftitle={TOLL: Tolled One-way Lanes for Lifelong pickup-and-delivery},
...
% tools/worked_examples.py; see the header of toll.tex.

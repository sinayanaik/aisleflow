...
\multirow{5}{*}{bottleneck}
 ...
 & TOLL (full) & \textbf{0.145} & 154.3 & 1.45 & 0.095 \\
...
\begin{tabular}{@{}lrrrl@{}}
\toprule
\textbf{Map} & \textbf{best TOLL} & \textbf{plain PIBT} & \textbf{difference} & \textbf{$p$} \\
\midrule
...
\bottomrule
\end{tabular}
\caption{The best TOLL configuration on each map --- \variant{aisle\_direction\_only}
...
\begin{enumerate}
\item \textbf{Against the published baselines, TOLL wins decisively and
...
\subsection{Reading these numbers}
...
them is visible in a raw column:

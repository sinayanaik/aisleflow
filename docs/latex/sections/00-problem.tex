...
\begin{equation}
  ...
  \qquad
  \Theta_{1000} = 1000\,\Theta,
  \label{eq:throughput}
\end{equation}
subject to the joint plan being conflict-free at every step. Every figure and
table in \Cref{sec:results} reports $\Theta_{1000}$ rather than $\Theta$: the
same measurement, stated per 1000 timesteps, because 149 and 118 are easier to
tell apart than $0.149$ and $0.118$. Makespan --- the
...
\variant{warehouse\_medium} tasks arrive at $\lambda = 1.5$ per timestep ---
1500 per 1000 timesteps --- and the best configuration completes about 502 per
1000; on \variant{warehouse\_bottleneck}, 800 offered against 149 served. Between
...
even when they look small: 502 against 313 tasks per 1000 timesteps is a
$61\%$ difference in the capacity of the warehouse.

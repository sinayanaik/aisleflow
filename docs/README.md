...
| document | what it is |
|---|---|
| [`pdf/toll-paper.pdf`](pdf/toll-paper.pdf) | **The paper.** 48 pages: the problem stated formally, the four prior methods and how each fails here, what TOLL-PIBT changes and why, the whole system in full detail, and what the measurements said. Source: [`latex/`](latex/). |
...
| [`pdf/toll-mapf-presentation.pdf`](pdf/toll-mapf-presentation.pdf) | The project-review deck, 37 slides. Also [with speaker notes](pdf/toll-mapf-presentation-notes.pdf). Source: [`deck/slides.html`](deck/slides.html). |
...
`latex/toll.tex` is the preamble and the `\input` list; `latex/sections/`
